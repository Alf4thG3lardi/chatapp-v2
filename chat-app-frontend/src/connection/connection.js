...
export const ConnectionProvider = ({children}) => {
  ...
  return (
    <Connection.Provider value={{
      getChatusers, chatusers, setChatusers, chatuser, setChatuser, getChatuser, userForm, chatuserValue, setChatuserValue, setChatuserForm, storeChatuser,
      chatroom, setChatroom, getChatroom, chatroomForm, chatroomValue, setChatroomValue, setChatroomForm, storeChatroom,
      chatroomusers, setChatroomusers, getChatroomusers, storeChatroomuser, chatroomuserForm, setChatroomuserForm, chatroomuserValue, setChatroomuserValue,
      messages, setMessages, getMessages, messageForm, messageValue, setChatroomValue, setMessageForm,storeMessage,
